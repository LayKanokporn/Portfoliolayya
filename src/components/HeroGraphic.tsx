  ...
  return (
    ...
    >
      <defs>
        ...
        <linearGradient id="hg-bg-dark" x1="0" y1="0" x2="0" y2="1">
      ...
      {/* Background panel */}
      <rect x="6" y="6" width="348" height="248" rx="12" className="fill-[#f8faff] dark:fill-[#0f172a]" stroke="none" />
      <rect x="6" y="6" width="348" height="248" rx="12" fill="none" className="stroke-[#e5e7eb] dark:stroke-[#1e293b]" />

      {/* Soft orb behind sink */}
      <circle cx="280" cy="130" r="70" fill="url(#hg-orb)" />

      {/* Subtle dot grid — uses <pattern> instead of 117 circle elements */}
      <rect x="6" y="6" width="348" height="248" rx="12" fill="url(#hg-dots)" className="text-[#cbd5e1] dark:text-[#1e293b]" opacity="0.6" />
      ...
      >
        <rect x="178" y="108" width="48" height="48" rx="10" className="fill-white dark:fill-[#0f172a]" stroke="#1a56db" strokeWidth="2" />
        ...
        <text x="202" y="170" textAnchor="middle" fontSize="9" className="fill-[#6b7280] dark:fill-[#94a3b8]" fontFamily="ui-sans-serif">
          Orchestrate
        </text>
      </motion.g>
      ...
      >
        <g transform="translate(36 226)">
          <rect width="80" height="20" rx="10" className="fill-white dark:fill-[#0f172a]" stroke="none" />
          <rect width="80" height="20" rx="10" fill="none" className="stroke-[#e5e7eb] dark:stroke-[#1e293b]" />
          <text x="40" y="13" textAnchor="middle" className="fill-[#6b7280] dark:fill-[#94a3b8]">Logging by default</text>
        </g>
        <g transform="translate(132 226)">
          <rect width="90" height="20" rx="10" className="fill-white dark:fill-[#0f172a]" stroke="none" />
          <rect width="90" height="20" rx="10" fill="none" className="stroke-[#e5e7eb] dark:stroke-[#1e293b]" />
          <text x="45" y="13" textAnchor="middle" className="fill-[#6b7280] dark:fill-[#94a3b8]">Idempotent · Retry</text>
        </g>
        <g transform="translate(238 226)">
          <rect width="86" height="20" rx="10" className="fill-white dark:fill-[#0f172a]" stroke="none" />
          <rect width="86" height="20" rx="10" fill="none" className="stroke-[#e5e7eb] dark:stroke-[#1e293b]" />
          <text x="43" y="13" textAnchor="middle" className="fill-[#6b7280] dark:fill-[#94a3b8]">Audit-traceable</text>
        </g>
      </motion.g>
    </svg>
  );
...
function Node({
  ...
  return (
    <g transform={`translate(${x} ${y})`}>
      <rect width="78" height="40" rx="10" className="fill-white dark:fill-[#0f172a]" stroke={tone} strokeWidth="2" />
      <text x="14" y="18" fontSize="12" fontFamily="ui-sans-serif" fontWeight="500" className="fill-[#111827] dark:fill-[#f1f5f9]">
        {label}
      </text>
      <text x="14" y="32" fontSize="9" fontFamily="ui-sans-serif" className="fill-[#6b7280] dark:fill-[#94a3b8]">
        {sub}
      </text>
