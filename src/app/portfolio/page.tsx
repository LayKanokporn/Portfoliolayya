...
const EXPERIENCE = [
  ...
  },
  {
    ...
    company: "Sunrise LINE Bots — cafe operations automation (built for own use)",
    period: "2025 – Present",
    duration: "In daily use 16+ weeks",
    location: "Bangkok, Thailand",
    active: true,
    type: "work" as const,
    stack: ["Google Apps Script", "LINE Messaging API v2", "Flex Messages", "Google Sheets", "CacheService"],
    responsibilities: [
      "Built a 2-bot LINE OA suite to automate daily bookkeeping and stock entry for a family cafe — cut from ~30 to ~5 min/day (~83%)",
      "Applied production patterns end-to-end: idempotent webhook with dedup, defer queue for long tasks, structured logging with error sheet — zero silent failures",
...
const PROJECTS: {
...
}[] = [
  {
    ...
    role: "Personal project · 2025 – Present",
    category: "Personal project",
    image: "/project-sunrise.jpg",
    art: "bot",
    desc: "2-bot LINE OA suite (KaiJa + Stock Sunrise) I built for a family cafe — expense tracking, stock management, order intake, slip OCR, and Flex-based reporting.",
    impact: {
